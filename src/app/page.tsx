...
export default function Home(): JSX.Element {
  return (
    <>
      <Background />
      <main className="relative min-h-screen flex flex-col items-center justify-start gap-8 p-12 bg-transparent font-fira-code">
        <Intro
        ...
        <div className="w-full max-w-4xl bg-[#1a1b26]/40 backdrop-blur-xl rounded-lg shadow-2xl border border-[#7aa2f7]/20 transition-all duration-150 p-12 hover:-translate-y-1 hover:shadow-3xl hover:border-[#7aa2f7]/40">
